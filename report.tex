...
The source code, data, and other artifacts w.r.t. the reproduction package have been made available at \url{https://github.com/iTsluku/RepEng-SpeadsheetSolver-ReproductionPackage}. The equivalent for the report is available at \url{https://github.com/iTsluku/RepEng-SpeadsheetSolver-Report}.
\endgroup
}
%%% VLDB block end %%%
